                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#adminAccordion">
                        <div class="accordion-body p-0">
                            ...
                            <div class="p-4 text-center border-bottom border-primary" id="masterKeyUploadUI" style="background-color: var(--bs-body-bg);">
                                ...
                                <button class="btn btn-primary fw-bold px-4 py-2 btn-master-key" style="border-radius: 8px;" onclick="document.getElementById('masterKeyFileInput').click()">
        ...
        function loadMasterKey(event) {
            ...
            reader.onload = function(e) {
                try {
                    ...
                    if (keyData.private_key && keyData.system === "Sentinel Master Audit Vault") {
                        sessionMasterKey = keyData.private_key; // Save to temporary JS memory!
